...
async function factory (pkgName) {
  ...
  class Sumba extends this.app.baseClass.Base {
    ...
    constructor () {
      ...
      /**
       * Secure guards containers
       * @type {Array}
       */
      this.secureGuards = []

      /**
       * Action guards container
       * @type {Array}
       */
      this.actionGuards = []

      /**
       * Query guards container
       * @type {Array}
       */
      this.queryGuards = []

      /**
       * Attribute guards container
       * @type {Array}
       */
      this.attribGuards = []

      /**
       * Anonymous guards container
       * @type {Array}
       */
      this.anonymousGuards = []

      /**
       * Download directory path for storing exported files.
       * @type {string}
       */
      this.downloadDir = null

      /**
       * Unsafe user fields that should not be exposed or returned in API responses.
       * @type {string[]}
       */
     ...
     * Check route guard
     * @method
     * @param {Array} guards - The array of guard object
